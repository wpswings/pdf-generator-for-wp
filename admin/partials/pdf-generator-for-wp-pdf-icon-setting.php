...
<section class="mwb-section">
	<form action="" method="POST" class="mwb-pgfw-gen-section-form">
		<div class="pgfw-section-wrap">
			...
			?>
			<div><?php echo esc_html__( 'Add', 'pdf-generator-for-wp' ) . ' <b>[PGFW_GENERATE_PDF]</b> ' . esc_html__( 'shortcode anywhere on your page or posts to display PDF generating icon.' ); ?></div>
		</div>
	</form>
</section>
