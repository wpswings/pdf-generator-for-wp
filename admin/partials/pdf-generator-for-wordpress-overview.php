<div class="mwb-overview__wrapper">
	<div class="mwb-overview__banner">
		<img src="<?php echo esc_html( PDF_GENERATOR_FOR_WORDPRESS_DIR_URL ); ?>admin/src/images/pdfgeneratorbannerimage.png" alt="Overview banner image">
	</div>
	<div class="mwb-overview__content">
		<div class="mwb-overview__content-description">
			<h2><?php echo esc_html_e( 'What is PDF Generator?', 'pdf-generator-for-wordpress' ); ?></h2>
			<p>
				<?php
				esc_html_e(
		...
		<div class="mwb-overview__keywords">
			<div class="mwb-overview__keywords-item">
				<div class="mwb-overview__keywords-card">
					<div class="mwb-overview__keywords-image">
						<img src="<?php echo esc_html( PDF_GENERATOR_FOR_WORDPRESS_DIR_URL . 'admin/src/images/includedetails.jpg' ); ?>" alt="Advanced-report image">
					</div>
					<div class="mwb-overview__keywords-text">
						<h3 class="mwb-overview__keywords-heading"><?php echo esc_html_e( 'Include Details', 'pdf-generator-for-wordpress' ); ?></h3>
			...
			<div class="mwb-overview__keywords-item">
				<div class="mwb-overview__keywords-card">
					<div class="mwb-overview__keywords-image">
						<img src="<?php echo esc_html( PDF_GENERATOR_FOR_WORDPRESS_DIR_URL . 'admin/src/images/seticonalignment.jpg' ); ?>" alt="Workflow image">
					</div>
					<div class="mwb-overview__keywords-text">
						<h3 class="mwb-overview__keywords-heading"><?php esc_html_e( 'Set Icon Alignment', 'pdf-generator-for-wordpress' ); ?></h3>
						<p class="mwb-overview__keywords-description"><?php esc_html_e( 'By using the display settings, the PDF generator plugin provides flexibility to choose if users and guest users will be able to see the icon. It has the features to let you decide the alignment of your icon in the WordPress site and if you want to send the PDF to the user’s e-mail.', 'pdf-generator-for-wordpress' ); ?></p>
					</div>
				</div>
			</div>
			<div class="mwb-overview__keywords-item">
				<div class="mwb-overview__keywords-card">
					<div class="mwb-overview__keywords-image">
						<img src="<?php echo esc_html( PDF_GENERATOR_FOR_WORDPRESS_DIR_URL . 'admin/src/images/customizepdf.jpg' ); ?>" alt="Variable product image">
					</div>
					<div class="mwb-overview__keywords-text">
						<h3 class="mwb-overview__keywords-heading"><?php esc_html_e( 'Customize Your PDF', 'pdf-generator-for-wordpress' ); ?></h3>
						<p class="mwb-overview__keywords-description">
							<?php
							esc_html_e(
			...
			<div class="mwb-overview__keywords-item">
				<div class="mwb-overview__keywords-card">
					<div class="mwb-overview__keywords-image">
						<img src="<?php echo esc_html( PDF_GENERATOR_FOR_WORDPRESS_DIR_URL . 'admin/src/images/releventplacement.jpg' ); ?>" alt="List-of-abandoned-users image">
					</div>
					<div class="mwb-overview__keywords-text">
						<h3 class="mwb-overview__keywords-heading"><?php esc_html_e( 'Relevant Placement', 'pdf-generator-for-wordpress' ); ?></h3>
						<p class="mwb-overview__keywords-description">
							<?php
							esc_html_e(
			...
			<div class="mwb-overview__keywords-item">
				<div class="mwb-overview__keywords-card mwb-card-support">
					<div class="mwb-overview__keywords-image">
						<img src="<?php echo esc_html( PDF_GENERATOR_FOR_WORDPRESS_DIR_URL . 'admin/src/images/metafields.jpg' ); ?>" alt="Support image">
					</div>
					<div class="mwb-overview__keywords-text">
						<h3 class="mwb-overview__keywords-heading"><?php esc_html_e( 'Select Appropriate Metafields', 'pdf-generator-for-wordpress' ); ?></h3>
						<p class="mwb-overview__keywords-description">
							<?php
							esc_html_e(
			...
			<div class="mwb-overview__keywords-item">
				<div class="mwb-overview__keywords-card mwb-card-support">
					<div class="mwb-overview__keywords-image">
						<img src="<?php echo esc_html( PDF_GENERATOR_FOR_WORDPRESS_DIR_URL . 'admin/src/images/uploadyourpdf.jpg' ); ?>" alt="Support image">
					</div>
					<div class="mwb-overview__keywords-text">
						<h3 class="mwb-overview__keywords-heading"><?php esc_html_e( 'Upload Your Own PDF', 'pdf-generator-for-wordpress' ); ?></h3>
						<p class="mwb-overview__keywords-description">
							<?php
							esc_html_e(
