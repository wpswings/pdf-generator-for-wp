	...
	public function pgfw_admin_general_settings_page( $pgfw_settings_general_html_arr ) {
		...
		$pgfw_settings_general_html_arr   = array(
			...
			array(
				...
				'type'         => 'checkbox',
				'description'  => __( 'Categories will be shown on PDF( for post ).', 'pdf-generator-for-wordpress' ),
			...
			array(
				...
				'type'        => 'checkbox',
				'description' => __( 'Tags will be shown on PDF( for post ).', 'pdf-generator-for-wordpress' ),
	...
	public function pgfw_admin_header_settings_page( $pgfw_settings_header_fields_html_arr ) {
		...
		$pgfw_settings_header_fields_html_arr   = array(
			...
			array(
				...
				'parent-class' => 'mwb_pgfw_setting_separate_border',
				'placeholder'  => __( 'top', 'pdf-generator-for-wordpress' ),
				'min'          => -500,
				'max'          => 500,
			),
		);
	...
	public function pgfw_admin_footer_settings_page( $pgfw_settings_footer_fields_html_arr ) {
		...
		$pgfw_settings_footer_fields_html_arr   = array(
			...
			array(
				...
				'parent-class' => 'mwb_pgfw_setting_separate_border',
				'placeholder'  => __( 'bottom', 'pdf-generator-for-wordpress' ),
				'min'          => -500,
				'max'          => 500,
			),
		);
	...
	public function pgfw_admin_body_settings_page( $pgfw_body_html_arr ) {
		...
		$pgfw_body_html_arr   = array(
			array(
				...
				'type'        => 'select',
				'description' => __( 'Please choose title font style.', 'pdf-generator-for-wordpress' ),
			...
			array(
				...
				'options'      => array(
					...
					'b0'                       => __( 'B0', 'pdf-generator-for-wordpress' ),
					'b1'                       => __( 'B1', 'pdf-generator-for-wordpress' ),
					'b2'                       => __( 'B2', 'pdf-generator-for-wordpress' ),
					'b3'                       => __( 'B3', 'pdf-generator-for-wordpress' ),
					'b4'                       => __( 'B4', 'pdf-generator-for-wordpress' ),
					'b5'                       => __( 'B5', 'pdf-generator-for-wordpress' ),
					'b6'                       => __( 'B6', 'pdf-generator-for-wordpress' ),
					'c0'                       => __( 'C0', 'pdf-generator-for-wordpress' ),
					'c1'                       => __( 'C1', 'pdf-generator-for-wordpress' ),
					'c2'                       => __( 'C2', 'pdf-generator-for-wordpress' ),
					'c3'                       => __( 'C3', 'pdf-generator-for-wordpress' ),
					'c4'                       => __( 'C4', 'pdf-generator-for-wordpress' ),
					'c5'                       => __( 'C5', 'pdf-generator-for-wordpress' ),
					'c6'                       => __( 'C6', 'pdf-generator-for-wordpress' ),
					'ra0'                      => __( 'RA0', 'pdf-generator-for-wordpress' ),
					'ra1'                      => __( 'RA1', 'pdf-generator-for-wordpress' ),
					'ra2'                      => __( 'RA2', 'pdf-generator-for-wordpress' ),
					'ra3'                      => __( 'RA3', 'pdf-generator-for-wordpress' ),
					'ra4'                      => __( 'RA4', 'pdf-generator-for-wordpress' ),
					'sra0'                     => __( 'SRA0', 'pdf-generator-for-wordpress' ),
					'sra1'                     => __( 'SRA1', 'pdf-generator-for-wordpress' ),
					'sra2'                     => __( 'SRA2', 'pdf-generator-for-wordpress' ),
					'sra3'                     => __( 'SRA3', 'pdf-generator-for-wordpress' ),
					'sra4'                     => __( 'SRA4', 'pdf-generator-for-wordpress' ),
					...
					'ledger'                   => __( 'Ledger', 'pdf-generator-for-wordpress' ),
					'tabloid'                  => __( 'Tabloid', 'pdf-generator-for-wordpress' ),
					'folio'                    => __( 'Folio', 'pdf-generator-for-wordpress' ),
					'commercial #10 envelope'  => __( 'Commercial Envelope', 'pdf-generator-for-wordpress' ),
					'catalog #10 1/2 envelope' => __( 'Catalog Envelope', 'pdf-generator-for-wordpress' ),
					'8.5x11'                   => '8.5x11',
					'8.5x14'                   => '8.5x14',
					'11x17'                    => '11x17',
				),
