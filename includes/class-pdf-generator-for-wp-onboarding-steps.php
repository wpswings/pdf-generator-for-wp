	...
	public function wps_pgfw_add_on_boarding_form_fields() {
		...
		$fields = array(
			...
			wp_rand() => array(
				...
				'class'       => '',
				'options'     => array(
					'agency'                  => esc_html__( 'Agency', 'pdf-generator-for-wp' ),
					'consumer-services'       => esc_html__( 'Consumer Services', 'pdf-generator-for-wp' ),
					'ecommerce'               => esc_html__( 'Ecommerce', 'pdf-generator-for-wp' ),
					'financial-services'      => esc_html__( 'Financial Services', 'pdf-generator-for-wp' ),
					'healthcare'              => esc_html__( 'Healthcare', 'pdf-generator-for-wp' ),
					'manufacturing'           => esc_html__( 'Manufacturing', 'pdf-generator-for-wp' ),
					'nonprofit-and-education' => esc_html__( 'Nonprofit and Education', 'pdf-generator-for-wp' ),
					'professional-services'   => esc_html__( 'Professional Services', 'pdf-generator-for-wp' ),
					'real-estate'             => esc_html__( 'Real Estate', 'pdf-generator-for-wp' ),
					'software'                => esc_html__( 'Software', 'pdf-generator-for-wp' ),
					'startups'                => esc_html__( 'Startups', 'pdf-generator-for-wp' ),
					'restaurant'              => esc_html__( 'Restaurant', 'pdf-generator-for-wp' ),
					'fitness'                 => esc_html__( 'Fitness', 'pdf-generator-for-wp' ),
					'jewelry'                 => esc_html__( 'Jewelry', 'pdf-generator-for-wp' ),
					'beauty'                  => esc_html__( 'Beauty', 'pdf-generator-for-wp' ),
					'celebrity'               => esc_html__( 'Celebrity', 'pdf-generator-for-wp' ),
					'gaming'                  => esc_html__( 'Gaming', 'pdf-generator-for-wp' ),
					'government'              => esc_html__( 'Government', 'pdf-generator-for-wp' ),
					'sports'                  => esc_html__( 'Sports', 'pdf-generator-for-wp' ),
					'retail-store'            => esc_html__( 'Retail Store', 'pdf-generator-for-wp' ),
					'travel'                  => esc_html__( 'Travel', 'pdf-generator-for-wp' ),
					'political-campaign'      => esc_html__( 'Political Campaign', 'pdf-generator-for-wp' ),
				),
			),
	...
	public function wps_pgfw_add_deactivation_form_fields() {
		...
		$fields = array(
			...
			wp_rand() => array(
				...
				'options'     => array(
					'temporary-deactivation-for-debug' => esc_html__( 'It is a temporary deactivation. I am just debugging an issue.', 'pdf-generator-for-wp' ),
					'site-layout-broke'                => esc_html__( 'The plugin broke my layout or some functionality.', 'pdf-generator-for-wp' ),
					'complicated-configuration'        => esc_html__( 'The plugin is too complicated to configure.', 'pdf-generator-for-wp' ),
					'no-longer-need'                   => esc_html__( 'I no longer need the plugin', 'pdf-generator-for-wp' ),
					'found-better-plugin'              => esc_html__( 'I found a better plugin', 'pdf-generator-for-wp' ),
					'other'                            => esc_html__( 'Other', 'pdf-generator-for-wp' ),
				),
			),
