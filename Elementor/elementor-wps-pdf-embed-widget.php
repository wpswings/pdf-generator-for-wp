...
class Elementor_Widget_WPS_PDF_Embed extends Widget_Base {
	...
	public function get_title() {
		return __('WPSwings PDF Embed', 'textdomain');
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __('PDF Settings', 'textdomain'),
			]
		);
		...
		$this->add_control(
			'pdf_url',
			[
				'label'       => __('PDF File', 'textdomain'),
				'type'        => Controls_Manager::MEDIA,
				'media_type'  => 'application/pdf',
				'description' => __('Upload a PDF file to embed.', 'textdomain'),
				'default'     => [
