...
$this->_smarty_include(
	array(
		'smarty_include_tpl_file' => 'header.tpl',
		'smarty_include_vars' => array(
			'eltype' => 'class',
			'hasel' => true,
			'contents' => $this->_tpl_vars['classcontents'],
		),
	)
);
...
<?php
if ( $this->_tpl_vars['conflicts']['conflict_type'] ) :
	?>
...
<h3><a href="#class_details">
<?php
if ( $this->_tpl_vars['is_interface'] ) :
	?>
	Interface
	<?php
else :
	?>
	Class<?php endif; ?> Overview</a></h3>
<pre>
<?php
	...
	for ( $this->_sections['tag']['index'] = $this->_sections['tag']['start'], $this->_sections['tag']['iteration'] = 1;
		...
		<?php if ( $this->_tpl_vars['tags'][ $this->_sections['tag']['index'] ]['keyword'] == 'version' ) : ?>
			...
			echo smarty_function_assign(
				array(
					'var' => 'version',
					'value' => $this->_tpl_vars['tags'][ $this->_sections['tag']['index'] ]['data'],
				),
				$this
			);
			?>
...
$this->_smarty_include(
	array(
		...
		'smarty_include_vars' => array(
			'type' => 'class',
			'sdesc' => $this->_tpl_vars['sdesc'],
			'desc' => $this->_tpl_vars['desc'],
		),
	)
);
$this->_tpl_vars = $_smarty_tpl_vars;
...
<div class="tags">
	...
	$this->_smarty_include(
		array(
			'smarty_include_tpl_file' => 'var.tpl',
			'smarty_include_vars' => array(),
		)
	);
	$this->_tpl_vars = $_smarty_tpl_vars;
...
<div class="tags">
	...
	$this->_smarty_include(
		array(
			'smarty_include_tpl_file' => 'method.tpl',
			'smarty_include_vars' => array(),
		)
	);
	$this->_tpl_vars = $_smarty_tpl_vars;
...
<div class="tags">
	...
	$this->_smarty_include(
		array(
			'smarty_include_tpl_file' => 'const.tpl',
			'smarty_include_vars' => array(),
		)
	);
	$this->_tpl_vars = $_smarty_tpl_vars;
...
$this->_smarty_include(
	array(
		'smarty_include_tpl_file' => 'footer.tpl',
		'smarty_include_vars' => array(),
	)
);
$this->_tpl_vars = $_smarty_tpl_vars;
