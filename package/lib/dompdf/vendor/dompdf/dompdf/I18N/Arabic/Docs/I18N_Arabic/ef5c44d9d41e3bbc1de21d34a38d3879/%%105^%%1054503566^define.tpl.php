...
"></a>
 ...
 <span class="smalllinenumber">[line 
	<?php
	if ( $this->_tpl_vars['defines'][ $this->_sections['def']['index'] ]['slink'] ) :
	...
	$this->_smarty_include(
		array(
			...
			'smarty_include_vars' => array(
				'sdesc' => $this->_tpl_vars['defines'][ $this->_sections['def']['index'] ]['sdesc'],
				'desc' => $this->_tpl_vars['defines'][ $this->_sections['def']['index'] ]['desc'],
				'tags' => $this->_tpl_vars['defines'][ $this->_sections['def']['index'] ]['tags'],
			),
		)
	);
