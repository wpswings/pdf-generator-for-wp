...
$this->_smarty_include(
	array(
		...
		'smarty_include_vars' => array(
			'eltype' => 'Procedural file',
			'class_name' => $this->_tpl_vars['name'],
			'hasel' => true,
			'contents' => $this->_tpl_vars['pagecontents'],
		),
	)
);
...
$this->_smarty_include(
	array(
		...
		'smarty_include_vars' => array( 'type' => 'page' ),
	)
);
$this->_tpl_vars = $_smarty_tpl_vars;
unset( $_smarty_tpl_vars );
...
$this->_smarty_include(
	array(
		'smarty_include_tpl_file' => 'include.tpl',
		'smarty_include_vars' => array(),
	)
);
$this->_tpl_vars = $_smarty_tpl_vars;
...
$this->_smarty_include(
	array(
		'smarty_include_tpl_file' => 'global.tpl',
		'smarty_include_vars' => array(),
	)
);
$this->_tpl_vars = $_smarty_tpl_vars;
...
$this->_smarty_include(
	array(
		'smarty_include_tpl_file' => 'define.tpl',
		'smarty_include_vars' => array(),
	)
);
$this->_tpl_vars = $_smarty_tpl_vars;
...
$this->_smarty_include(
	array(
		'smarty_include_tpl_file' => 'function.tpl',
		'smarty_include_vars' => array(),
	)
);
$this->_tpl_vars = $_smarty_tpl_vars;
