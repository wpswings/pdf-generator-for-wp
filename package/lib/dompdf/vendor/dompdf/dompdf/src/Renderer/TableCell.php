	...
	function render( Frame $frame ) {
		...
		foreach ( $cells['columns'] as $j ) {
			...
			if ( $bp['top']['width'] > 0 ) {
				...
				$border_function_calls[] = array( $method, array( $x, $y, $w, $bp['top']['color'], $widths, 'top', 'square' ) );
			}
			...
			if ( $draw_bottom ) {
				...
				$border_function_calls[] = array( $method, array( $x, $y, $w, $bp['bottom']['color'], $widths, 'bottom', 'square' ) );
			} else {
		...
		foreach ( $cells['rows'] as $i ) {
			...
			if ( $bp['left']['width'] > 0 ) {
				...
				$border_function_calls[] = array( $method, array( $x, $y, $h, $bp['left']['color'], $widths, 'left', 'square' ) );
			}
			...
			if ( $draw_right ) {
				...
				$border_function_calls[] = array( $method, array( $x, $y, $h, $bp['right']['color'], $widths, 'right', 'square' ) );
			} else {
